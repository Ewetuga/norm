...
const Home = () => {
  ...
  const [medications, setMedications] = useState([
    { id: 1, name: 'Paracetamol', dose: '10mg', time: '08:00', frequency: 'Once daily', taken: false, takenTime: null },
    { id: 2, name: 'Amlodipine', dose: '5mg', time: '20:00', frequency: 'Once daily', taken: false, takenTime: null }
  ]);
              ...
              <div className="form-group checkbox-group">
                <label className="checkbox-label">
                  <input
                    ...
                    onChange={handleMedicationChange}
                  />
                  <span className="checkbox-text">Set reminder notification</span>
                </label>
              </div>
